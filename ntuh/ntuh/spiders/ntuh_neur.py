...
class NtuhNEUR(scrapy.Spider):
    name = "ntuhNEUR"
    allowed_domains = ["gov.tw"]
    start_urls = [
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=NEUR&Hosp=T0&SubDeptCode=&isSubDept=N&week=1",
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=NEUR&Hosp=T0&SubDeptCode=&isSubDept=N&week=2"
    ]
