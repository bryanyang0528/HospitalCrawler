...
class NtuhONC(scrapy.Spider):
    name = "ntuhONC"
    allowed_domains = ["gov.tw"]
    start_urls = [
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ONC&Hosp=T0&SubDeptCode=&isSubDept=N&week=1",
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ONC&Hosp=T0&SubDeptCode=&isSubDept=N&week=2"
    ]
