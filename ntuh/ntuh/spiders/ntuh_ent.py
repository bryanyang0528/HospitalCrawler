...
class NtuhENT(scrapy.Spider):
    name = "ntuhENT"
    allowed_domains = ["gov.tw"]
    start_urls = [
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ENT&Hosp=T0&SubDeptCode=&isSubDept=N&week=1",
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ENT&Hosp=T0&SubDeptCode=&isSubDept=N&week=2"
    ]
