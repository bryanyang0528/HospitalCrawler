...
class NtuhSURG(scrapy.Spider):
    name = "ntuhSURG"
    allowed_domains = ["gov.tw"]
    start_urls = [
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=SURG&Hosp=T0&SubDeptCode=&isSubDept=N&week=1",
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=SURG&Hosp=T0&SubDeptCode=&isSubDept=N&week=2"
    ]
