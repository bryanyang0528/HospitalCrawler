...
class NtuhORTH(scrapy.Spider):
    name = "ntuhORTH"
    allowed_domains = ["gov.tw"]
    start_urls = [
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ORTH&Hosp=T0&SubDeptCode=&isSubDept=N&week=1",
        "https://reg.ntuh.gov.tw/webadministration/DoctorTable.aspx?Dept=ORTH&Hosp=T0&SubDeptCode=&isSubDept=N&week=2"
    ]
